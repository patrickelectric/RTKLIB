                   ...
                   char **ofile, char **dir, int *trace)
{
    ...
    if(nf>=4) {
        opt->freqtype|=FREQTYPE_L6;
    }
    if(nf>=5) {
        opt->freqtype|=FREQTYPE_L7;
    }
    if(nf>=6) {
        opt->freqtype|=FREQTYPE_L8;
    }
    if(nf>=7) {
        opt->freqtype|=FREQTYPE_L9;
    }
